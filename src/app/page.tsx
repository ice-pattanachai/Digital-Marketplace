...
import { ArrowDownToLine, CheckCircle, Leaf,CircleAlert  } from "lucide-react";
...
const perks = [
  {
    ...
    Icon: CircleAlert ,
    description:
      'text content path: src-app-page.tsx',
  },
  {
    name: 'content',
    Icon: CircleAlert ,
      ...
      <MaxWidthWrapper>
        <div className='py-20 mx-auto text-center flex flex-col items-center max-w-3xl'>
          ...
          <div className='flex flex-col sm:flex-row gap-4 mt-6'>
            <Link href='/products' className={buttonVariants()}>Browse Trendinf</Link>
